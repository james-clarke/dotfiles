...
# launchers: Plasma 6 keys app shortcuts by desktop-file id, "shortcut,default,label"
term=org.kde.konsole.desktop
command -v ghostty >/dev/null && term=com.mitchellh.ghostty.desktop
set_key kglobalshortcutsrc "$term" _launch 'Meta+Return,none,Terminal'
set_key kglobalshortcutsrc dotfiles-emacs.desktop _launch 'Meta+E,none,Emacs'
set_key kglobalshortcutsrc org.kde.krunner.desktop _launch 'Meta+D,none,KRunner'
